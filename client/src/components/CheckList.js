...
export default class CheckList extends Component {
  ...
  render(){
    ...
    return (
      <span>
      {this.props.isCheckListOpen ?
      <div className="checkList">
          <ul>
            <li><i className="far fa-check-circle circle"></i>create a new event by clicking on plus icon on day</li>
            <li><i className="far fa-check-circle circle"></i>users can choose a month to display by clicking on month</li>
            ...
            <li><i className="far fa-check-circle circle"></i>UI appropriate amount of rows and columns for specified month</li>
